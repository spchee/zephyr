...
static const struct uart_cmsdk_apb_config uart_cmsdk_apb_dev_cfg_0 = {
	...
	IF_ENABLED(CONFIG_PINCTRL, (.pctrl = PINCTRL_DT_INST_DEV_CONFIG_GET(0),))
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
...
#endif
IF_ENABLED(CONFIG_PINCTRL, (PINCTRL_DT_INST_DEFINE(1);))
static const struct uart_cmsdk_apb_config uart_cmsdk_apb_dev_cfg_1 = {
	...
	IF_ENABLED(CONFIG_PINCTRL, (.pctrl = PINCTRL_DT_INST_DEV_CONFIG_GET(1),))
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
...
#endif
#ifdef CONFIG_PINCTRL
IF_ENABLED(CONFIG_PINCTRL, (PINCTRL_DT_INST_DEFINE(2);))
#endif /* CONFIG_PINCTRL*/
static const struct uart_cmsdk_apb_config uart_cmsdk_apb_dev_cfg_2 = {
	...
	IF_ENABLED(CONFIG_PINCTRL, (.pctrl = PINCTRL_DT_INST_DEV_CONFIG_GET(2),))
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
...
#endif
IF_ENABLED(CONFIG_PINCTRL, (PINCTRL_DT_INST_DEFINE(3);))
static const struct uart_cmsdk_apb_config uart_cmsdk_apb_dev_cfg_3 = {
	...
	IF_ENABLED(CONFIG_PINCTRL, (.pctrl = PINCTRL_DT_INST_DEV_CONFIG_GET(3),))
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
...
#endif
IF_ENABLED(CONFIG_PINCTRL, (PINCTRL_DT_INST_DEFINE(4);))
static const struct uart_cmsdk_apb_config uart_cmsdk_apb_dev_cfg_4 = {
	...
	IF_ENABLED(CONFIG_PINCTRL, (.pctrl = PINCTRL_DT_INST_DEV_CONFIG_GET(4),))
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
